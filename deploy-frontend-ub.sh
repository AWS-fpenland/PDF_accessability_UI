...
# --------------------------------------------------
# Frontend Deployment Script - UB Demo Branch
# Usage: ./deploy-frontend-ub.sh <PROJECT_NAME> <PDF_TO_PDF_BUCKET> <PDF_TO_HTML_BUCKET> <ROLE_ARN>
# --------------------------------------------------
...
echo "🚀 Starting Frontend Deployment (UB Demo Branch)..."
echo "📋 Parameters:"
...
SOURCE_VERSION="fpenland/demo/UB"
...
echo "  - Branch Deployed: fpenland/demo/UB"
